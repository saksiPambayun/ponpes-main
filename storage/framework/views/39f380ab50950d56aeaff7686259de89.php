                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-600">
                                    <?php echo e(\Carbon\Carbon::parse($wave->start_date)->format('d/m/Y')); ?></div>
                                <div class="text-xs text-gray-400">s/d
                                    <?php echo e(\Carbon\Carbon::parse($wave->end_date)->format('d/m/Y')); ?></div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-3">
                                    ...
                                    <form id="delete-form-<?php echo e($wave->id); ?>"
                                        action="<?php echo e(route('admin.pendaftaran.waves.destroy', $wave)); ?>" method="POST"
                                        style="display: none;">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/pendaftaran/waves/index.blade.php ENDPATH**/ ?>