                        ...
                        <div class="card border-0 shadow-sm mb-4"
                            ...
                            <div class="card-body" style="background: #ffffff; padding: 1.25rem;">
                                ...
                                <div class="text-center mb-3">
                                    ...
                                    <?php if($existingLogo): ?>
                                        <img src="<?php echo e(asset('storage/' . $profil->logo)); ?>" alt="Logo Saat Ini"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes ifadah\resources\views/admin/data-master/profil-yayasan/edit.blade.php ENDPATH**/ ?>