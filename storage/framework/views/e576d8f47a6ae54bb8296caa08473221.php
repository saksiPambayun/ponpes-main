            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4">
                ...
                <?php if(auth()->check() && auth()->user()->role === 'superadmin'): ?>
                    <div class="mb-6">
                        ...
                        <a href="<?php echo e(route('admin.admin-management.index')); ?>"
                            class="sidebar-item flex items-center px-4 py-3 text-green-100 rounded-lg mb-1 <?php echo e(request()->routeIs('admin.admin-management.*') ? 'active' : ''); ?>">
                            <div
                                class="icon-wrapper w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center mr-3">
...
</html><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/layout.blade.php ENDPATH**/ ?>