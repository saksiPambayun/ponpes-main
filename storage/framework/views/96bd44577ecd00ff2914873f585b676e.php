<?php $__env->startSection('title', 'Tambah Gelombang Pendaftaran'); ?>
<?php $__env->startSection('page-title', 'Tambah Gelombang Pendaftaran'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card" style="background: #fff; border-radius: 20px; max-width: 800px; margin: 0 auto;">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('admin.pendaftaran.waves.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        value="<?php echo e(old('name')); ?>" placeholder="Contoh: Gelombang 1" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="quota"
                            ...
                            value="<?php echo e(old('quota')); ?>" placeholder="Kosongkan jika tidak terbatas" min="1">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                        placeholder="Informasi tambahan tentang gelombang ini..."><?php echo e(old('description')); ?></textarea>
                </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/pendaftaran/waves/create.blade.php ENDPATH**/ ?>