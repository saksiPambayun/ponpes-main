                        ...
                        <div>
                            ...
                            <?php if($santri->dok_kk): ?>
                                <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                                    ...
                                    <?php if(in_array(strtolower(pathinfo($santri->dok_kk, PATHINFO_EXTENSION)), ['jpg','jpeg','png'])): ?>
                                        <img src="<?php echo e(asset('storage/' . $santri->dok_kk)); ?>"
                                            class="h-24 rounded border object-cover mb-2" alt="KK">
                                    <?php else: ?>
                                        <div class="flex items-center gap-2">
                                            <i class="fas fa-file-pdf text-red-500"></i>
                                            <span class="text-xs text-gray-600 truncate"><?php echo e(basename($santri->dok_kk)); ?></span>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <label for="dok_kk" class="flex flex-col items-center justify-center w-full h-24 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($santri->dok_kk ? 'Ganti file' : 'Upload file'); ?> · PDF, JPG, PNG (maks. 20MB)</p>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if($santri->dok_akta): ?>
                                <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                                    <p class="text-xs text-green-700 font-medium mb-2">✓ File saat ini:</p>
                                    <?php if(in_array(strtolower(pathinfo($santri->dok_akta, PATHINFO_EXTENSION)), ['jpg','jpeg','png'])): ?>
                                        <img src="<?php echo e(asset('storage/' . $santri->dok_akta)); ?>"
                                            class="h-24 rounded border object-cover mb-2" alt="Akta">
                                    <?php else: ?>
                                        <div class="flex items-center gap-2">
                                            <i class="fas fa-file-pdf text-red-500"></i>
                                            <span class="text-xs text-gray-600 truncate"><?php echo e(basename($santri->dok_akta)); ?></span>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <label for="dok_akta" class="flex flex-col items-center justify-center w-full h-24 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition">
                                <div class="flex flex-col items-center justify-center">
                                    <i class="fas fa-cloud-upload-alt text-xl text-gray-400 mb-1"></i>
                                    <p class="text-xs text-gray-500"><?php echo e($santri->dok_akta ? 'Ganti file' : 'Upload file'); ?> · PDF, JPG, PNG (maks. 20MB)</p>
                                </div>
