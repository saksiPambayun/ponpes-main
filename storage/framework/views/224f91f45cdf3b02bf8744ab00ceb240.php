            ...
            <div>
                <select id="waveFilter" class="border border-gray-300 rounded-lg px-4 py-2">
                    ...
                    <?php $__currentLoopData = $waves ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($wave->id); ?>"><?php echo e($wave->name); ?></option>
...
<?php /**PATH C:\laragon\www\ponpes-main\resources\views/admin/santri/partials/table-pendaftar.blade.php ENDPATH**/ ?>