<?php $__env->startSection('title', 'Edit Akta Wakaf'); ?>
<?php $__env->startSection('page-title', 'Edit Akta Wakaf'); ?>
...
<?php $__env->startSection('content'); ?>
    <div style="max-width: 80rem; margin: 0 auto;">
        <div style="background: #fff; border-radius: 20px; padding: 2rem; box-shadow: 0 2px 20px rgba(0,0,0,0.06); border: 1px solid #dfe8d8;">
            <form action="<?php echo e(route('admin.akta-wakaf.update', $aktaWakaf->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
                    <div>
                        ...
                        <input type="text" name="nomor_sertifikat"
                            value="<?php echo e(old('nomor_sertifikat', $aktaWakaf->nomor_sertifikat)); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" name="nazhir" value="<?php echo e(old('nazhir', $aktaWakaf->nazhir)); ?>"
                            style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #dfe8d8; border-radius: 10px; background: #f4f4f4; transition: all 0.2s ease;"
                            onfocus="this.style.borderColor='#005F02'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 3px rgba(0,95,2,0.12)'"
                            onblur="this.style.borderColor='#dfe8d8'; this.style.background='#f4f4f4'; this.style.boxShadow='none'">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi_tanah"
                            value="<?php echo e(old('lokasi_tanah', $aktaWakaf->lokasi_tanah)); ?>"
                            style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #dfe8d8; border-radius: 10px; background: #f4f4f4; transition: all 0.2s ease;"
                            onfocus="this.style.borderColor='#005F02'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 3px rgba(0,95,2,0.12)'"
                            onblur="this.style.borderColor='#dfe8d8'; this.style.background='#f4f4f4'; this.style.boxShadow='none'">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="luas_tanah" value="<?php echo e(old('luas_tanah', $aktaWakaf->luas_tanah)); ?>"
                            style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #dfe8d8; border-radius: 10px; background: #f4f4f4; transition: all 0.2s ease;"
                            onfocus="this.style.borderColor='#005F02'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 3px rgba(0,95,2,0.12)'"
                            onblur="this.style.borderColor='#dfe8d8'; this.style.background='#f4f4f4'; this.style.boxShadow='none'">
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <textarea name="deskripsi" rows="4"
                            ...
                            onfocus="this.style.borderColor='#005F02'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 3px rgba(0,95,2,0.12)'"
                            onblur="this.style.borderColor='#dfe8d8'; this.style.background='#f4f4f4'; this.style.boxShadow='none'"><?php echo e(old('deskripsi', $aktaWakaf->deskripsi)); ?></textarea>
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <?php if($aktaWakaf->file_sertifikat): ?>
                            <p style="font-size: 0.7rem; color: #8cbf73; margin-top: 0.5rem;">File saat ini: <?php echo e(basename($aktaWakaf->file_sertifikat)); ?></p>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views\admin\akta-wakaf\edit.blade.php ENDPATH**/ ?>