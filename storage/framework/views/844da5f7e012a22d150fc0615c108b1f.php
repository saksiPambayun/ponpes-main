...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Al Ifadah</title>
...
<div style="display:flex; min-height:100vh;">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.profil-yayasan.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.profil-yayasan*') ? 'active' : ''); ?>">
                <i class="fas fa-building"></i>
                <span>Profil Yayasan</span>
            </a>

            <a href="<?php echo e(route('admin.data-master.struktur-organisasi.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.data-master.struktur-organisasi*') ? 'active' : ''); ?>">
                <i class="fas fa-sitemap"></i>
                <span>Struktur Organisasi</span>
            </a>

            <a href="<?php echo e(route('admin.data-master.fasilitas.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.data-master.fasilitas*') ? 'active' : ''); ?>">
                <i class="fas fa-school"></i>
                <span>Fasilitas</span>
            </a>

            <a href="<?php echo e(route('admin.data-master.gallery.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.data-master.gallery*') ? 'active' : ''); ?>">
                <i class="fas fa-images"></i>
                <span>Gallery</span>
            </a>

            <a href="<?php echo e(route('admin.data-master.program.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.data-master.program*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.santri.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.santri*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.pegawai.index')); ?>"
               class="nav-link-item <?php echo e(request()->routeIs('admin.pegawai*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-footer">
            <div class="sidebar-user">
                ...
                <div>
                    ...
                    <div class="sidebar-user-role"><?php echo e(Auth::user()->role ?? 'Superadmin'); ?></div>
                </div>
            </div>
        </div>
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            ...
            <span class="topbar-title d-none d-md-block"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></span>
                ...
                <div class="dropdown">
                    <a href="#" class="topbar-user" data-toggle="dropdown">
                        ...
                        <div class="topbar-user-info">
                            ...
                            <span class="topbar-user-role"><?php echo e(Auth::user()->role ?? 'Superadmin'); ?></span>
                        </div>
        ...
        <footer class="main-footer">
            &copy; <?php echo e(date('Y')); ?> Pondok Pesantren Al Ifadah &mdash; Sistem Manajemen Admin
        </footer>
...
</html><?php /**PATH C:\laragon\www\ponpes-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>