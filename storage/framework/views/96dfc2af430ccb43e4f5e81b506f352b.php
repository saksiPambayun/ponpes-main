...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto">
        <div class="card p-8">
            <form action="<?php echo e(route('admin.pendaftar.store')); ?>?via=admin" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 mt-1">
                            <label class="inline-flex items-center">
                                <input type="radio" name="jenis_kelamin" value="Laki-laki" <?php echo e(old('jenis_kelamin') == 'Laki-laki' ? 'checked' : ''); ?> class="form-radio text-green-600">
                                <span class="ml-2">Laki-laki</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="jenis_kelamin" value="Perempuan" <?php echo e(old('jenis_kelamin') == 'Perempuan' ? 'checked' : ''); ?> class="form-radio text-green-600">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/santri/create.blade.php ENDPATH**/ ?>