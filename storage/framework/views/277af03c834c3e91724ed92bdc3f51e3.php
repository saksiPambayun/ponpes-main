<?php $__env->startSection('title', 'Masukan'); ?>
<?php $__env->startSection('page-title', 'Masukan'); ?>

<?php $__env->startSection('content'); ?>
    <div class="flex justify-between items-center mb-6">
        <div>
            <h3 class="text-xl font-bold text-gray-900">Masukan</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500">Total Masukan</p>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <?php if($feedback->phone): ?>
                                <div class="text-xs text-gray-400 mt-1">
                                    <i class="fab fa-whatsapp text-green-500"></i> <?php echo e($feedback->phone); ?>
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center space-x-3">
                                ...
                                <form id="delete-form-<?php echo e($feedback->id); ?>"
                                    action="<?php echo e(route('admin.feedback.destroy', $feedback->id)); ?>" method="POST"
                                    style="display: none;">
                                    <?php echo csrf_field(); ?>
