...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="<?php echo e(!$feedback->is_read ? 'bg-yellow-50' : ''); ?> hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm whitespace-nowrap"><?php echo e($feedback->created_at->format('d M Y H:i')); ?>
        ...
        <div class="px-6 py-4 border-t border-gray-200">
            <?php if($feedbacks->hasPages()): ?>
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-500">
                        Menampilkan <?php echo e($feedbacks->firstItem()); ?> sampai <?php echo e($feedbacks->lastItem()); ?> dari
                        <?php echo e($feedbacks->total()); ?> data
                    </div>
                    <div class="flex gap-1">
                        
                        <?php if($feedbacks->onFirstPage()): ?>
                            <span class="px-3 py-1 rounded-md bg-gray-100 text-gray-400 cursor-not-allowed">
                                <i class="fas fa-chevron-left"></i> Previous
                            </span>
                        <?php else: ?>
                            <a href="<?php echo e($feedbacks->previousPageUrl()); ?>"
                        ...
                        <?php $__currentLoopData = $feedbacks->getUrlRange(1, $feedbacks->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $feedbacks->currentPage()): ?>
                                <span class="px-3 py-1 rounded-md bg-green-600 text-white"><?php echo e($page); ?></span>
                            <?php else: ?>
                                <a href="<?php echo e($url); ?>" class="px-3 py-1 rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200">
                                    <?php echo e($page); ?>
                        ...
                        <?php if($feedbacks->hasMorePages()): ?>
                            <a href="<?php echo e($feedbacks->nextPageUrl()); ?>"
                                class="px-3 py-1 rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200">
            ...
            <?php else: ?>
                <div class="text-sm text-gray-500">
                    Menampilkan <?php echo e($feedbacks->count()); ?> data
                </div>
            <?php endif; ?>
        </div>
    </div>
