            ...
            <tbody id="tableDitolak">
                <?php $__empty_1 = true; $__currentLoopData = $santri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4">
                            <span
                                class="text-xs text-red-600 line-clamp-2"><?php echo e(Str::limit($item->alasan_penolakan, 50)); ?></span>
                        </td>
...
<?php /**PATH C:\laragon\www\ponpes-main\resources\views/admin/santri/partials/table-ditolak.blade.php ENDPATH**/ ?>