                ...
                <div class="form-group-section">
                    ...
                    <div class="biaya-detail-box">
                        ...
                        <?php $__currentLoopData = getBiayaPendaftaran(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biaya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $totalBiaya += $biaya->nominal; ?>
                            <div class="biaya-row">
                                <div class="biaya-col">
                                    <strong><?php echo e($biaya->nama_biaya); ?></strong>
                                    <?php if($biaya->keterangan): ?>
                                        <small><?php echo e($biaya->keterangan); ?></small>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="biaya-total">
                            <div class="biaya-row">
                                ...
                                <div class="biaya-col text-end">
                                    <strong class="text-success"><?php echo e(formatRupiah($totalBiaya)); ?></strong>
                                </div>
                            </div>
