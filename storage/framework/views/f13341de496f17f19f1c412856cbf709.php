                ...
                <div class="form-group">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                            <input type="radio" name="otp_method" value="email" checked class="w-4 h-4 text-green-600">
                            <i class="fas fa-envelope text-gray-600"></i>
                            <div>
                                <div class="font-medium">Verifikasi via Email</div>
                                <div class="text-sm text-gray-500">Kode OTP akan dikirim ke email Anda</div>
                            </div>
                        </label>
                        <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                            <input type="radio" name="otp_method" value="whatsapp" class="w-4 h-4 text-green-600">
                            <i class="fab fa-whatsapp text-green-600"></i>
                            <div>
                                <div class="font-medium">Verifikasi via WhatsApp</div>
                                <div class="text-sm text-gray-500">Kode OTP akan dikirim ke WhatsApp Anda</div>
                            </div>
                        </label>
                    </div>
                    <?php $__errorArgs = ['otp_method'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group" id="whatsappField" style="display: none;">
                    <label class="form-label">
                        Nomor WhatsApp <span class="required" id="whatsappRequired">*</span>
                    </label>
                    <div class="input-wrapper">
                        <i class="fab fa-whatsapp input-icon text-green-600"></i>
                        <input type="tel" name="whatsapp_number" value="<?php echo e(old('whatsapp_number')); ?>"
                            class="input-field <?php $__errorArgs = ['whatsapp_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        // Toggle WhatsApp field based on selected method
        const otpMethodRadios = document.querySelectorAll('input[name="otp_method"]');
        const whatsappField = document.getElementById('whatsappField');
        const whatsappRequired = document.getElementById('whatsappRequired');
        ...
        otpMethodRadios.forEach(radio => {
            radio.addEventListener('change', function () {
                if (this.value === 'whatsapp') {
                    ...
                    whatsappRequired.style.display = 'inline';
                } else {
                    whatsappField.style.display = 'none';
                    whatsappInput.required = false;
                    whatsappRequired.style.display = 'none';
                }
            });
        });
        ...
        if (selectedMethod && selectedMethod.value === 'whatsapp') {
            whatsappField.style.display = 'block';
            whatsappInput.required = true;
            whatsappRequired.style.display = 'inline';
        } else {
...
</html><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/auth/register.blade.php ENDPATH**/ ?>