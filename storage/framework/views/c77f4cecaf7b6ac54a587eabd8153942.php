...
<?php $__env->startSection('content'); ?>
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <a href="<?php echo e(route('admin.data-master.gallery.create')); ?>" class="btn btn-primary" style="background: #005F02; border: none;">
    ...
    <?php if(session('success')): ?>
        <div class="alert alert-success alert-dismissible fade show mb-4" role="alert" style="background: #eef3ec; border-left: 4px solid #005F02; color: #0d4f14;">
            <i class="fas fa-check-circle me-2" style="color: #005F02;"></i> <?php echo e(session('success')); ?>
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-center" style="background: #ffffff; border-radius: 16px; border: 1px solid #dfe8d8;">
                <div class="card-body">
                    ...
                    <h3 class="mb-0" style="color: #222;"><?php echo e($galleries->total() ?? 0); ?></h3>
    ...
    <div class="card mb-4" style="background: #ffffff; border-radius: 16px; border: 1px solid #dfe8d8;">
        ...
        <div class="card-body" style="background: #ffffff;">
            <form method="GET" action="<?php echo e(route('admin.data-master.gallery.index')); ?>" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-5 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('admin.data-master.gallery.index')); ?>" class="btn" style="background: #dfe8d8; color: #333; border: none; border-radius: 8px; padding: 8px 20px; text-decoration: none;">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="table-row" style="border-bottom: 1px solid #dfe8d8;">
                            ...
                            <td>
                                <strong style="color: #222;"><?php echo e($gallery->judul ?? '-'); ?></strong>
                                <?php if($gallery->deskripsi): ?>
                                    <br><small class="text-muted" style="color: #666;"><?php echo e(Str::limit($gallery->deskripsi, 50)); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php
                                ...
                                ?>
                                <span class="badge" style="background: <?php echo e($color['bg']); ?>; color: <?php echo e($color['color']); ?>; padding: 5px 12px; border-radius: 20px; font-size: 0.75rem;">
                                    <?php echo e(ucfirst($gallery->kategori ?? 'Umum')); ?>

                                </span>
                            </td>
                            <td style="color: #333;">
                                <?php echo e($gallery->created_at ? \Carbon\Carbon::parse($gallery->created_at)->format('d/m/Y') : '-'); ?>

                            </td>
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('admin.data-master.gallery.show', $gallery->id)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('admin.data-master.gallery.edit', $gallery->id)); ?>" 
                                    ...
                                    <button onclick="openDeleteModal(<?php echo e($gallery->id); ?>, '<?php echo e(addslashes($gallery->judul)); ?>')" 
                                ...
                                <form id="deleteForm<?php echo e($gallery->id); ?>" 
                                      action="<?php echo e(route('admin.data-master.gallery.destroy', $gallery->id)); ?>" 
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="text-center py-5" style="background: #ffffff;">
                                ...
                                <a href="<?php echo e(route('admin.data-master.gallery.create')); ?>" class="btn btn-sm mt-3" style="background: #005F02; color: #ffffff; border: none; border-radius: 8px;">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/data-master/profil-yayasan/index.blade.php ENDPATH**/ ?>