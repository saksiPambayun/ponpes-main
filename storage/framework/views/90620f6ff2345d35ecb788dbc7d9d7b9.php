                    ...
                    <?php if($feedback->is_replied): ?>
                        <div class="mb-4 p-4 bg-green-50 rounded-lg border border-green-200">
                            <div class="flex justify-between mb-2">
                                ...
                                <span class="text-xs text-green-600"><?php echo e($feedback->replied_at->format('d M Y H:i')); ?></span>
                            </div>
                            <p class="text-gray-700"><?php echo e(nl2br(e($feedback->reply_message))); ?></p>
                        </div>
                    <?php endif; ?>

                    <form action="<?php echo e(route('admin.feedback.reply', $feedback->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ponpes-main\resources\views/admin/feedback/show.blade.php ENDPATH**/ ?>