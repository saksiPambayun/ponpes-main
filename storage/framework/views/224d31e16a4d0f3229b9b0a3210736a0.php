                    ...
                    <tbody>
                        <?php $__currentLoopData = $akta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 border"><?php echo e($item->nomor_akta ?? '-'); ?></td>
                                <td class="px-4 py-2 border"><?php echo e($item->tanggal_akta ?? '-'); ?></td>
                                <td class="px-4 py-2 border"><?php echo e($item->notaris ?? '-'); ?></td>
                                <td class="px-4 py-2 border text-center">
                                    <a href="<?php echo e(route('user.akta-yayasan.show', $item->id)); ?>"
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ponpes-main\resources\views/user/akta-yayasan/index.blade.php ENDPATH**/ ?>