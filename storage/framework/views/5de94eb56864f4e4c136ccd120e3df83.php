                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="deskripsi" rows="4"
                            ...
                            placeholder="Masukkan deskripsi..."><?php echo e(old('deskripsi', $aktaWakaf->deskripsi)); ?></textarea>
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <?php if($aktaWakaf->file_sertifikat): ?>
                            <p class="text-xs text-gray-500 mt-1">File saat ini: <?php echo e(basename($aktaWakaf->file_sertifikat)); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ponpes-main\resources\views/admin/akta-wakaf/edit.blade.php ENDPATH**/ ?>