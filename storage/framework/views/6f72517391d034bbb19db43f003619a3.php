...
<div class="page-wrapper">
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('admin.data-master.struktur-organisasi.create')); ?>" class="btn-primary-action">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-icon" style="background: <?php echo e($s['accent']); ?>18; color: <?php echo e($s['accent']); ?>;">
    ...
    <div class="section-card">
        ...
        <div class="section-card-body">
            <form action="<?php echo e(route('admin.data-master.struktur-organisasi.index')); ?>" method="GET" class="filter-form">
                ...
                <div class="filter-group">
                    ...
                    <select name="divisi" class="form-select">
                        ...
                        <?php $__currentLoopData = $divisiOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(request('divisi') == $val ? 'selected' : ''); ?>>
                                <?php echo e($label); ?>
                ...
                <div class="filter-group filter-actions">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.data-master.struktur-organisasi.index')); ?>" class="btn-reset">
    ...
    <div class="section-card">
        <div class="section-card-header">
           ...
           <span class="total-badge"><?php echo e($anggota->count()); ?> anggota</span>
        </div>
        <div class="section-card-body p-0">
            <div class="table-responsive">
                <table class="data-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="td-no">
                                <span class="row-number"><?php echo e($anggota->firstItem() + $i); ?></span>
                            </td>
                            <td>
                                <div class="avatar-wrap">
                                    <?php if($item->foto): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->foto)); ?>"
                                             class="member-avatar" alt="<?php echo e($item->nama); ?>">
                                    <?php else: ?>
                            ...
                            <td>
                                <span class="member-name"><?php echo e($item->nama); ?></span>
                            </td>
                            <td>
                                <span class="jabatan-text"><?php echo e($item->jabatan); ?></span>
                            </td>
                            <td>
                                <?php
                                    $divisiMap = [
                                ...
                                <span class="divisi-badge"
                                      style="color: <?php echo e($ds['color']); ?>; background: <?php echo e($ds['bg']); ?>;">
                                    <i class="fas <?php echo e($ds['icon']); ?>"></i>
                            ...
                            <td>
                                <div class="action-group">
                                    <a href="<?php echo e(route('admin.data-master.struktur-organisasi.show', $item)); ?>"
                                       class="action-btn view" title="Lihat Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.data-master.struktur-organisasi.edit', $item)); ?>"
                                       class="action-btn edit" title="Edit">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.data-master.struktur-organisasi.destroy', $item)); ?>"
                                          method="POST"
                                          class="d-inline"
        ...
        <div class="pagination-footer">
            <p class="pagination-info">
                Menampilkan
                <strong><?php echo e($anggota->firstItem()); ?></strong>–<strong><?php echo e($anggota->lastItem()); ?></strong>
                dari <strong><?php echo e($anggota->total()); ?></strong> anggota
            </p>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ponpes-main\resources\views/data-master/struktur-organisasi/index.blade.php ENDPATH**/ ?>