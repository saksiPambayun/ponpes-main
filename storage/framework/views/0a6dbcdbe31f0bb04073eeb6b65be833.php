<?php $__env->startSection('title', 'Profil Yayasan'); ?><?php $__env->startSection('content'); ?>
    <div class="page-wrapper" style="background: #f0f4f8; min-height: 100vh; padding: 2rem;">
        ...
        <a href="<?php echo e(route('admin.data-master.profil-yayasan.edit')); ?>"
        ...
        <?php if(session('success')): ?>
            <div class="alert-success-box"
                ...
                <span style="color: #15803d;"><?php echo e(session('success')); ?></span>
            </div>
        <?php endif; ?>
                        ...
                        <div style="display: grid; gap: 0.75rem;">
                            <div style="display: flex; padding: 0.5rem 0; border-bottom: 1px solid #f0f4f8;">
                                <div style="width: 140px; font-size: 0.82rem; font-weight: 600; color: #64748b;">Nama
                                    Yayasan</div>
                                <div style="flex: 1; font-size: 0.87rem; color: #1a1f36;"><?php echo e($profil->nama_yayasan ?? '-'); ?>
                            ...
                            <div style="display: flex; padding: 0.5rem 0; border-bottom: 1px solid #f0f4f8;">
                                ...
                                <div style="flex: 1; font-size: 0.87rem; color: #1a1f36;">
                                    ...
                                    <?php if($profil->kota || $profil->provinsi): ?>
                                        <br><span
                                            style="color: #64748b;"><?php echo e(implode(', ', array_filter([$profil->kota, $profil->provinsi, $profil->kode_pos]))); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div style="display: flex; padding: 0.5rem 0; border-bottom: 1px solid #f0f4f8;">
                                ...
                                <div style="flex: 1; font-size: 0.87rem; color: #1a1f36;"><?php echo e($profil->telepon ?? '-'); ?>

                                </div>
                            </div>
                            <div style="display: flex; padding: 0.5rem 0; border-bottom: 1px solid #f0f4f8;">
                                <div style="width: 100px; font-size: 0.82rem; font-weight: 600; color: #64748b;">Email</div>
                                <div style="flex: 1; font-size: 0.87rem; color: #1a1f36;"><?php echo e($profil->email ?? '-'); ?></div>
                            </div>
                            <div style="display: flex; padding: 0.5rem 0;">
                                <div style="width: 100px; font-size: 0.82rem; font-weight: 600; color: #64748b;">Website
                                </div>
                                <div style="flex: 1; font-size: 0.87rem; color: #1a1f36;"><?php echo e($profil->website ?? '-'); ?>
                    ...
                    <div class="section-card-body" style="padding: 1.5rem;">
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                            ...
                            <div>
                                ...
                                <div style="font-size: 0.85rem; color: #1a1f36;"><?php echo e($profil->facebook ?? '-'); ?></div>
                            </div>
                            <div>
                                <div style="font-size: 0.75rem; font-weight: 600; color: #64748b; margin-bottom: 0.25rem;">
                                    <i class="fab fa-youtube" style="color: #ff0000;"></i> YouTube</div>
                                <div style="font-size: 0.85rem; color: #1a1f36;"><?php echo e($profil->youtube ?? '-'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views/admin/data-master/profil-yayasan/index.blade.php ENDPATH**/ ?>