                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-gray-900 leading-tight"><?php echo e($item->nama_lengkap); ?></p>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center gap-1.5">
                                    ...
                                    <?php if($item->dok_kk): ?>
                                        <a href="<?php echo e(asset('storage/' . $item->dok_kk)); ?>" target="_blank"
                                    ...
                                    <?php if($item->dok_akta): ?>
                                        <a href="<?php echo e(asset('storage/' . $item->dok_akta)); ?>" target="_blank"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views/admin/santri/index.blade.php ENDPATH**/ ?>