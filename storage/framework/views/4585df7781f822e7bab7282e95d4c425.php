                                ...
                                <td>
                                    <div class="action-group">
                                        ...
                                        <form id="deleteForm<?php echo e($item->id); ?>"
                                            action="<?php echo e(route('admin.data-master.fasilitas.destroy', $item->id)); ?>"
                                            method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" class="action-btn delete"
                                                onclick="openDeleteModal('<?php echo e($item->id); ?>', '<?php echo e(addslashes($item->nama_fasilitas)); ?>')">
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        ...
                                        <a href="<?php echo e(route('admin.data-master.fasilitas.create')); ?>"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/data-master/fasilitas/index.blade.php ENDPATH**/ ?>