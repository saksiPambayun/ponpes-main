        ...
        <?php if($user): ?>
            ...
            <div class="avatar-section">
                <div class="avatar-wrapper">
                    <?php if($user->avatar): ?>
                        <img src="<?php echo e(asset('storage/' . $user->avatar)); ?>" alt="Avatar" class="avatar-img">
                    <?php else: ?>
                ...
                <h2 class="user-name"><?php echo e($user->name); ?></h2>
                <div class="user-email"><?php echo e($user->email); ?></div>
                <?php if($user->phone): ?>
                    <div class="user-phone"><i class="fab fa-whatsapp"></i> <?php echo e($user->phone); ?></div>
                <?php endif; ?>
                ...
                <div class="user-stats">
                    <div class="user-stat">
                        <div class="user-stat-value"><?php echo e($user->created_at->format('d M Y')); ?></div>
                        <div class="user-stat-label">Bergabung</div>
                    </div>
                    <div class="user-stat">
                        <div class="user-stat-value"><?php echo e($user->updated_at->format('d M Y')); ?></div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-card">
                ...
                <div class="form-body">
                    <form action="<?php echo e(route('user.profile.change-password')); ?>" method="POST" id="passwordForm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views/user/profil/index.blade.php ENDPATH**/ ?>