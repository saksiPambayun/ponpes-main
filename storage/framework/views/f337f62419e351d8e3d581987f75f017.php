        ...
        <div class="page-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2rem;">
            <div class="page-header-left" style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div>
                    ...
                    <p style="font-size: 0.8rem; color: #8898aa; margin: 0;">Ubah data program: <?php echo e($program->nama_program); ?></p>
                </div>
            </div>
                    ...
                    <div class="row" style="display: flex; flex-wrap: wrap; gap: 1.5rem;">
                        <div class="col-md-6" style="flex: 1; min-width: 250px;">
                            <div class="form-group" style="margin-bottom: 1.3rem;">
                                ...
                                <input type="text" name="nama_program" class="form-control" style="width: 100%; padding: 0.65rem 0.9rem; border: 1.5px solid #e2e8f0; border-radius: 10px; background: #f8fafc;" value="<?php echo e(old('nama_program', $program->nama_program)); ?>" placeholder="Masukkan nama program" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6" style="flex: 1; min-width: 250px;">
                            <div class="form-group" style="margin-bottom: 1.3rem;">
                                ...
                                <input type="date" name="tanggal_mulai" class="form-control" style="width: 100%; padding: 0.65rem 0.9rem; border: 1.5px solid #e2e8f0; border-radius: 10px; background: #f8fafc;" value="<?php echo e(old('tanggal_mulai', $program->tanggal_mulai ? $program->tanggal_mulai->format('Y-m-d') : '')); ?>">
                            </div>

                            <div class="form-group" style="margin-bottom: 1.3rem;">
                                <label style="font-size: 0.82rem; font-weight: 600; color: #2d3748; display: block; margin-bottom: 0.4rem;">Tanggal Selesai</label>
                                <input type="date" name="tanggal_selesai" class="form-control" style="width: 100%; padding: 0.65rem 0.9rem; border: 1.5px solid #e2e8f0; border-radius: 10px; background: #f8fafc;" value="<?php echo e(old('tanggal_selesai', $program->tanggal_selesai ? $program->tanggal_selesai->format('Y-m-d') : '')); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 1.3rem;">
                        ...
                        <textarea name="deskripsi" rows="5" class="form-control" style="width: 100%; padding: 0.65rem 0.9rem; border: 1.5px solid #e2e8f0; border-radius: 10px; background: #f8fafc; resize: vertical;" placeholder="Jelaskan deskripsi program secara detail..."><?php echo e(old('deskripsi', $program->deskripsi)); ?></textarea>
                    ...
                    <div class="form-group" style="margin-bottom: 1.3rem;">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                            <label style="display: inline-flex; align-items: center; gap: 0.5rem;">
                                <input type="radio" name="status" value="aktif" <?php echo e(old('status', $program->status) == 'aktif' ? 'checked' : ''); ?>> <span>Aktif</span>
                            </label>
                            <label style="display: inline-flex; align-items: center; gap: 0.5rem;">
                                <input type="radio" name="status" value="selesai" <?php echo e(old('status', $program->status) == 'selesai' ? 'checked' : ''); ?>> <span>Selesai</span>
                            </label>
                            <label style="display: inline-flex; align-items: center; gap: 0.5rem;">
                                <input type="radio" name="status" value="dinunda" <?php echo e(old('status', $program->status) == 'dinunda' ? 'checked' : ''); ?>> <span>Ditunda</span>
                            </label>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-actions" style="display: flex; align-items: center; gap: 0.75rem; padding-top: 1rem; border-top: 1px solid #f0f4f8; margin-top: 1rem;">
                        ...
                        <a href="<?php echo e(route('admin.program.index')); ?>" class="btn-cancel" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.7rem 1.2rem; background: #fff5f5; border: 1.5px solid #fed7d7; border-radius: 10px; color: #e53e3e; font-size: 0.87rem; font-weight: 600; text-decoration: none;">
