...
<?php $__env->startSection('page-title', 'Edit Data Administrator'); ?>
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header"
                    ...
                    <h4 class="mb-0"><i class="fas fa-user-edit"></i> Edit Admin: <?php echo e($admin->name); ?></h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('admin.admin-management.update', $admin->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                rows="3"><?php echo e(old('address', $admin->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                                <option value="active" <?php echo e($admin->status == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="inactive" <?php echo e($admin->status == 'inactive' ? 'selected' : ''); ?>>Nonaktif
                                </option>
                            </select>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/admin-management/edit.blade.php ENDPATH**/ ?>