                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-group">
                                <a href="<?php echo e(route('data-master.gallery.show', $item->id)); ?>"
                                   class="action-btn view" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('data-master.gallery.edit', $item->id)); ?>"
                                   class="action-btn edit" title="Edit">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <form action="<?php echo e(route('data-master.gallery.destroy', $item->id)); ?>"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ponpes-main\resources\views/data-master/gallery/index.blade.php ENDPATH**/ ?>