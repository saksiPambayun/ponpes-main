                                ...
                                <td class="px-4 py-4 text-center" style="padding: 14px 16px;">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <form id="deleteForm<?php echo e($item->id); ?>"
                                            action="<?php echo e(route('admin.program.destroy', $item->id)); ?>" method="POST"
                                            class="inline">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <button type="button" class="p-1.5 rounded-lg" style="color: #dc2626;"
                                                title="Hapus"
                                                onclick="openDeleteModal('<?php echo e($item->id); ?>', '<?php echo e(addslashes($item->nama_program)); ?>')">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/esolusi2/SubDomain/al-ifadah.esolusindo.com/resources/views/admin/data-master/program/index.blade.php ENDPATH**/ ?>