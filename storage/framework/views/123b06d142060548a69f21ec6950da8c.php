    ...
    <div style="max-width: 80rem; margin: 0 auto;">
        <div style="background: #fff; border-radius: 20px; padding: 2rem; box-shadow: 0 2px 20px rgba(0,0,0,0.06); border: 1px solid #dfe8d8;">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
                <div>
                    <h3 style="font-size: 1.5rem; font-weight: 700; color: #222; margin: 0;"><?php echo e($aktaWakaf->nomor_sertifikat ?? 'Sertifikat Wakaf'); ?></h3>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
                <div style="background: #f4f4f4; padding: 1rem; border-radius: 12px; border: 1px solid #dfe8d8;">
                    ...
                    <p style="font-weight: 500; color: #222; margin: 0;"><?php echo e($aktaWakaf->nomor_sertifikat ?? '-'); ?></p>
                </div>
                <div style="background: #f4f4f4; padding: 1rem; border-radius: 12px; border: 1px solid #dfe8d8;">
                    <p style="font-size: 0.75rem; color: #2d2d2d; margin-bottom: 0.25rem;">Nazhir</p>
                    <p style="font-weight: 500; color: #222; margin: 0;"><?php echo e($aktaWakaf->nazhir ?? '-'); ?></p>
                </div>
                <div style="background: #f4f4f4; padding: 1rem; border-radius: 12px; border: 1px solid #dfe8d8;">
                    <p style="font-size: 0.75rem; color: #2d2d2d; margin-bottom: 0.25rem;">Lokasi Tanah</p>
                    <p style="font-weight: 500; color: #222; margin: 0;"><?php echo e($aktaWakaf->lokasi_tanah ?? '-'); ?></p>
                </div>
                <div style="background: #f4f4f4; padding: 1rem; border-radius: 12px; border: 1px solid #dfe8d8;">
                    <p style="font-size: 0.75rem; color: #2d2d2d; margin-bottom: 0.25rem;">Luas Tanah</p>
                    <p style="font-weight: 500; color: #222; margin: 0;"><?php echo e($aktaWakaf->luas_tanah ?? '-'); ?> m²</p>
                </div>
            </div>
                ...
                <?php if($aktaWakaf->file_sertifikat): ?>
                    <div style="display: flex; align-items: center; justify-content: space-between; background: #eef3ec; padding: 1rem; border-radius: 12px; flex-wrap: wrap; gap: 1rem;">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                <p style="font-weight: 500; color: #222; margin: 0;"><?php echo e(basename($aktaWakaf->file_sertifikat)); ?></p>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 1.5rem; border-top: 1px solid #dfe8d8; flex-wrap: wrap; gap: 1rem;">
                <a href="<?php echo e(route('admin.akta-wakaf.index')); ?>" style="color: #2d2d2d; text-decoration: none; transition: all 0.2s ease;">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views\admin\akta-wakaf\show.blade.php ENDPATH**/ ?>