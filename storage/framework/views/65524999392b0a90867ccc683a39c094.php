                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
                    ...
                    <div>
                        <label
                            ...
                            Akta</label>
                        <input type="date" name="tanggal_akta" value="<?php echo e(old('tanggal_akta', $aktaYayasan->tanggal_akta)); ?>"
                            style="width: 100%; padding: 0.75rem 1rem; border: 1.5px solid #dfe8d8; border-radius: 10px; background: #f4f4f4; transition: all 0.2s ease;"
                            onfocus="this.style.borderColor='#005F02'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 3px rgba(0,95,2,0.12)'"
                            onblur="this.style.borderColor='#dfe8d8'; this.style.background='#f4f4f4'; this.style.boxShadow='none'">
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <textarea name="deskripsi" rows="4"
                            ...
                            onfocus="this.style.borderColor='#005F02'; this.style.background='#ffffff'; this.style.boxShadow='0 0 0 3px rgba(0,95,2,0.12)'"
                            onblur="this.style.borderColor='#dfe8d8'; this.style.background='#f4f4f4'; this.style.boxShadow='none'"><?php echo e(old('deskripsi', $aktaYayasan->deskripsi)); ?></textarea>
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <?php if($aktaYayasan->file_akta): ?>
                            <p style="font-size: 0.7rem; color: #8cbf73; margin-top: 0.5rem;">File saat ini:
                                <?php echo e(basename($aktaYayasan->file_akta)); ?></p>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views\admin\akta-yayasan\edit.blade.php ENDPATH**/ ?>