...
<div class="container-fluid">
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('program.index')); ?>">Program</a></li>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('program.update', $program)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Masukkan deskripsi program"><?php echo e(old('deskripsi', $program->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="sosial"     <?php echo e(old('kategori', $program->kategori) == 'sosial'     ? 'selected' : ''); ?>>Sosial</option>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="dinunda" <?php echo e(old('status', $program->status) == 'dinunda' ? 'selected' : ''); ?>>Ditunda</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('tanggal_mulai', $program->tanggal_mulai?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('tanggal_selesai', $program->tanggal_selesai?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        ...
                        <div class="mb-2">
                            <img src="<?php echo e(asset('storage/' . $program->gambar)); ?>" alt="Gambar saat ini"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views\admin\program\edit.blade.php ENDPATH**/ ?>