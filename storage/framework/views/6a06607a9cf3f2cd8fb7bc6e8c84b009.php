                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-1">
                        <label class="inline-flex items-center">
                            <input type="radio" name="jenis_kelamin" value="Laki-laki" <?php echo e(old('jenis_kelamin', $santri->jenis_kelamin) == 'Laki-laki' ? 'checked' : ''); ?> class="form-radio text-green-600">
                            <span class="ml-2">Laki-laki</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="jenis_kelamin" value="Perempuan" <?php echo e(old('jenis_kelamin', $santri->jenis_kelamin) == 'Perempuan' ? 'checked' : ''); ?> class="form-radio text-green-600">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $santri->tempat_lahir)); ?>"
                        class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <select name="angkatan"
                        ...
                        <?php for($year = $startYear; $year <= $endYear; $year++): ?>
                            <option value="<?php echo e($year); ?>" <?php echo e(old('angkatan', $santri->angkatan ?? $currentYear) == $year ? 'selected' : ''); ?>>
                                <?php echo e($year); ?>
