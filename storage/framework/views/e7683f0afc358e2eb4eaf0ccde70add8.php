...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto">
        <div class="card p-8">
            <form action="<?php echo e(route('admin.akta-wakaf.update', $aktaWakaf->id)); ?>" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi_tanah" value="<?php echo e(old('lokasi_tanah', $aktaWakaf->lokasi_tanah)); ?>"
                            class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none">
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <?php if($aktaWakaf->file_sertifikat): ?>
                            <p class="text-xs text-gray-500 mt-1">File saat ini: <?php echo e(basename($aktaWakaf->file_sertifikat)); ?></p>
