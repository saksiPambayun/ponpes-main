<?php $__env->startSection('title', 'Hasil Cek Status Pendaftaran'); ?>
        ...
        <div class="container">
            <div class="hasil-card">
                <div class="card-header">
                    ...
                    <p>Ditemukan <strong><?php echo e($registrations->count()); ?></strong> data pendaftaran</p>
                </div>
                            ...
                            <?php $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($reg->nisn): ?>
                                            <br><small class="text-muted">NISN: <?php echo e($reg->nisn); ?></small>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($reg->wave->name ?? '-'); ?></td>
                                    <td><?php echo e($reg->created_at->format('d/m/Y')); ?></td>
                                    <td>
                                        <?php if($reg->acceptance_status == 'accepted'): ?>
                                            <span class="status-badge accepted">
                                                <i class="bi bi-check-circle-fill"></i> DITERIMA
                                            </span>
                                        <?php elseif($reg->acceptance_status == 'rejected'): ?>
                                            <span class="status-badge rejected">
                                                <i class="bi bi-x-circle-fill"></i> DITOLAK
                                            </span>
                                        <?php elseif($reg->acceptance_status == 'waiting_list'): ?>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('user.pendaftaran.status', $reg->id)); ?>" class="btn-detail">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views\user\pendaftaran\hasil-cek.blade.php ENDPATH**/ ?>