<?php $__env->startSection('title', 'Tambah Profil Yayasan'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('profil-yayasan.index')); ?>" class="text-decoration-none"
            ...
            <a href="<?php echo e(route('profil-yayasan.index')); ?>" class="btn btn-outline-secondary"
        ...
        <form action="<?php echo e(route('profil-yayasan.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('nama_yayasan')); ?>" placeholder="Contoh: Yayasan Peduli Bangsa"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="singkatan"
                                        class="form-control <?php $__errorArgs = ['singkatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('singkatan')); ?>" placeholder="Contoh: YPB"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('tahun_berdiri')); ?>" placeholder="Contoh: 2010" min="1900"
                                        max="<?php echo e(date('Y')); ?>" style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        style="border-color: #dfe8d8; border-radius: 10px;"><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        style="border-color: #dfe8d8; border-radius: 10px;"><?php echo e(old('visi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        style="border-color: #dfe8d8; border-radius: 10px;"><?php echo e(old('misi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('alamat')); ?>" placeholder="Jl. Contoh No. 1, Kelurahan, Kecamatan"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('kota')); ?>" placeholder="Contoh: Surabaya"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('provinsi')); ?>" placeholder="Contoh: Jawa Timur"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('kode_pos')); ?>" placeholder="Contoh: 60111"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('telepon')); ?>" placeholder="031-12345678"
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('email')); ?>" placeholder="email@yayasan.org"
                                            style="border-color: #dfe8d8; border-radius: 0 10px 10px 0;">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('website')); ?>" placeholder="https://www.yayasan.org"
                                            style="border-color: #dfe8d8; border-radius: 0 10px 10px 0;">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('instagram')); ?>" placeholder="username"
                                            style="border-color: #dfe8d8; border-radius: 0 10px 10px 0;">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('facebook')); ?>" placeholder="nama halaman / URL"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('youtube')); ?>" placeholder="nama channel / URL"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="no_akta"
                                        class="form-control <?php $__errorArgs = ['no_akta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('no_akta')); ?>" placeholder="AHU-001.AH.01"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
                                    <?php $__errorArgs = ['no_akta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="no_sk_kemenkumham"
                                        class="form-control <?php $__errorArgs = ['no_sk_kemenkumham'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('no_sk_kemenkumham')); ?>" placeholder="AHU-0001234.01"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
                                    <?php $__errorArgs = ['no_sk_kemenkumham'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="npwp" class="form-control <?php $__errorArgs = ['npwp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('npwp')); ?>" placeholder="01.234.567.8-910.000"
                                        style="border-color: #dfe8d8; border-radius: 10px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card border-0 shadow-sm"
                        ...
                        <div class="card-body d-grid gap-2 py-3" style="background: #ffffff;">
                            ...
                            <a href="<?php echo e(route('profil-yayasan.index')); ?>" class="btn btn-outline-secondary text-center"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes-main\resources\views\admin\data-master\profil-yayasan\create.blade.php ENDPATH**/ ?>