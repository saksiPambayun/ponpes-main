...
<div class="page-wrapper" style="background: #f0f4f8; min-height: 100vh; padding: 2rem;">
    ...
    <div class="page-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
        <div class="page-header-left" style="display: flex; align-items: center; gap: 1rem;">
            ...
            <div class="page-title">
                ...
                <p style="font-size: 0.8rem; color: #8898aa; margin: 0;"><i class="fas fa-calendar-alt mr-1"></i><?php echo e(now()->format('d F Y')); ?></p>
            </div>
        </div>

        <a href="<?php echo e(route('admin.data-master.gallery.index')); ?>" class="btn-back" style="display: inline-flex; align-items: center; gap: 0.45rem; padding: 0.55rem 1.1rem; background: #fff; border: 1.5px solid #e2e8f0; border-radius: 10px; color: #4a5568; font-size: 0.82rem; font-weight: 600; text-decoration: none;">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <form action="<?php echo e(route('admin.data-master.gallery.update', $gallery->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('judul', $gallery->judul)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="kegiatan" <?php echo e(old('kategori', $gallery->kategori) == 'kegiatan' ? 'selected' : ''); ?>>Kegiatan</option>
                                <option value="prestasi" <?php echo e(old('kategori', $gallery->kategori) == 'prestasi' ? 'selected' : ''); ?>>Prestasi</option>
                                <option value="umum" <?php echo e(old('kategori', $gallery->kategori) == 'umum' ? 'selected' : ''); ?>>Umum</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6" style="flex: 1; min-width: 250px;">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   name="urut"
                                   class="form-control <?php $__errorArgs = ['urut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('urut', $gallery->urut)); ?>"
                                   min="0"
                                   placeholder="Urutan tampilan (1, 2, 3...)">
                            <?php $__errorArgs = ['urut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                              rows="4"
                              placeholder="Tuliskan deskripsi gallery..."><?php echo e(old('deskripsi', $gallery->deskripsi)); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <?php if($gallery->gambar): ?>
                        <div class="current-photo">
                            <img src="<?php echo e(asset('storage/'.$gallery->gambar)); ?>"
                                 alt="<?php echo e($gallery->judul); ?>">
