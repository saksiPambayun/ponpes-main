        ...
        <div class="p-8">
                        ...
                        <div class="p-3">
                            <?php if($doc['file']): ?>
                                ...
                                <?php elseif(in_array($ext, ['jpg', 'jpeg', 'png', 'webp'])): ?>
                                    <a href="<?php echo e($fullPath); ?>" target="_blank" class="block group">
                                        <img src="<?php echo e($fullPath); ?>"
                                ...
                                <?php else: ?>
                                    <div class="h-44 bg-gray-100 rounded-lg flex flex-col items-center justify-center gap-2">
                                        ...
                                        <a href="<?php echo e($fullPath); ?>" target="_blank" class="text-xs text-blue-500 hover:underline">
                                            Lihat File
                                        </a>
                                    </div>
                                <?php endif; ?>
            ...
            <div class="flex justify-between items-center pt-6 mt-6 border-t border-gray-100">
                <div class="text-xs text-gray-400">
                    Dibuat: <?php echo e($pegawai->created_at ? $pegawai->created_at->format('d M Y H:i') : '-'); ?>

                    <?php if($pegawai->updated_at && $pegawai->updated_at != $pegawai->created_at): ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ponpes ifadah\resources\views/admin/pegawai/show.blade.php ENDPATH**/ ?>