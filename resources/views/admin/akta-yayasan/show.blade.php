        ...
        <div
            ...
            <div
                ...
                <div>
                    <h3 style="font-size: 1.5rem; font-weight: 700; color: #222; margin: 0;">
                        {{ $aktaYayasan->nomor_akta ?? 'Akta Yayasan' }}</h3>
            ...
            <div
                ...
                <div style="background: #f4f4f4; padding: 1rem; border-radius: 12px; border: 1px solid #dfe8d8;">
                    ...
                    <p style="font-weight: 500; color: #222; margin: 0;">{{ $aktaYayasan->nomor_akta ?? '-' }}</p>
                </div>
                <div style="background: #f4f4f4; padding: 1rem; border-radius: 12px; border: 1px solid #dfe8d8;">
                    <p style="font-size: 0.75rem; color: #2d2d2d; margin-bottom: 0.25rem;">Notaris</p>
                    <p style="font-weight: 500; color: #222; margin: 0;">{{ $aktaYayasan->notaris ?? '-' }}</p>
                </div>
            </div>

            @if($aktaYayasan->deskripsi)
                <div
                    ...
                    <p style="color: #333; margin: 0; line-height: 1.6;">{{ $aktaYayasan->deskripsi }}</p>
                </div>
            @endif
                ...
                @if($aktaYayasan->file_akta)
                    <div
                        ...
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                <p style="font-weight: 500; color: #222; margin: 0;">{{ basename($aktaYayasan->file_akta) }}</p>
