...
@push('forms')
    ...
    @foreach($santri as $item)
        @if($item->status == 'pending')
            <form id="verify-form-{{ $item->id }}" action="{{ route('admin.santri.verify', $item->id) }}" method="POST"
                style="display: none;">
                @csrf
            </form>

            <form id="reject-form-{{ $item->id }}" action="{{ route('admin.santri.reject', $item->id) }}" method="POST"
                style="display: none;">
                @csrf
            </form>
        @endif
