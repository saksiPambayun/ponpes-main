                                ...
                                <tr class="table-row" id="row-{{ $item->id }}">
                                    ...
                                    <td>
                                        <div class="btn-group gap-2 d-flex">
                                            ...
                                            <button type="button"
                                                onclick="toggleStatus({{ $item->id }}, '{{ addslashes($item->nama_biaya) }}', '{{ $item->status }}')"
                                                ...
                                                <span class="ms-1">{{ $item->status == 'aktif' ? 'Nonaktif' : 'Aktif' }}</span>
                                            </button>
                                            <button type="button"
                                                onclick="openDeleteModal({{ $item->id }}, '{{ addslashes($item->nama_biaya) }}')"
