                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('data-master.profil-yayasan') }}" class="btn btn-light">Kelola</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card bg-success text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('data-master.struktur-organisasi') }}" class="btn btn-light">Kelola</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card bg-info text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('data-master.fasilitas') }}" class="btn btn-light">Kelola</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('data-master.gallery') }}" class="btn btn-light">Kelola</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card bg-danger text-white">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('data-master.program') }}" class="btn btn-light">Kelola</a>
                                </div>
                            </div>
                        </div>
                    </div>
