                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_fasilitas"
                                    ...
                                    value="{{ old('nama_fasilitas') }}" placeholder="Masukkan nama fasilitas" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kategori"
                                    ...
                                    value="{{ old('kategori') }}" placeholder="Contoh: Laboratorium, Kelas, Olahraga">
                                @error('kategori')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror"
                                    value="{{ old('lokasi') }}" placeholder="Contoh: Gedung A Lantai 2">
                                @error('lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
