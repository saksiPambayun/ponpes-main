...
<div class="page-wrapper">
        ...
        <div class="header-left">
            ...
            <div>
                ...
                <nav class="breadcrumb-nav">
                    ...
                    <a href="{{ route('admin.profil-yayasan.index') }}" class="breadcrumb-link">Profil Yayasan</a>
                    <i class="fas fa-chevron-right breadcrumb-sep"></i>
                    <span class="breadcrumb-current">Edit</span>
                </nav>
            </div>
        </div>
        <a href="{{ route('admin.profil-yayasan.index') }}" class="btn-secondary-action">
    ...
    <form action="{{ route('admin.profil-yayasan.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-layout">
                        ...
                        <div class="field-grid">
                            <div class="field-item col-8">
                                ...
                                <input type="text" name="nama_yayasan"
                                       class="form-input @error('nama_yayasan') is-invalid @enderror"
                            ...
                            <div class="field-item col-4">
                                ...
                                <input type="text" name="singkatan"
                                       class="form-input @error('singkatan') is-invalid @enderror"
                            ...
                            <div class="field-item col-4">
                                ...
                                <input type="number" name="tahun_berdiri"
                                       class="form-input @error('tahun_berdiri') is-invalid @enderror"
                        ...
                        <div class="field-grid">
                            <div class="field-item col-12">
                                ...
                                <textarea name="visi" rows="3"
                                          class="form-input form-textarea @error('visi') is-invalid @enderror"
                            ...
                            <div class="field-item col-12">
                                ...
                                <textarea name="misi" rows="5"
                                          class="form-input form-textarea @error('misi') is-invalid @enderror"
                        ...
                        <div class="field-grid">
                            ...
                            <div class="field-item col-4">
                                ...
                                <input type="text" name="kode_pos"
                                       class="form-input @error('kode_pos') is-invalid @enderror"
                            ...
                            <div class="field-item col-4">
                                ...
                                <div class="input-with-prefix">
                                    ...
                                    <input type="text" name="telepon"
                                           class="form-input has-prefix @error('telepon') is-invalid @enderror"
                            ...
                            <div class="field-item col-4">
                                ...
                                <div class="input-with-prefix">
                                    ...
                                    <input type="email" name="email"
                                           class="form-input has-prefix @error('email') is-invalid @enderror"
                            ...
                            <div class="field-item col-4">
                                ...
                                <div class="input-with-prefix">
                                    ...
                                    <input type="url" name="website"
                                           class="form-input has-prefix @error('website') is-invalid @enderror"
                            ...
                            <div class="field-item col-4">
                                ...
                                <div class="input-with-prefix">
                                    ...
                                    <input type="text" name="instagram"
                                           class="form-input has-prefix @error('instagram') is-invalid @enderror"
            ...
            <div class="sidebar-col">
                ...
                <div class="section-card">
                    ...
                    <div class="section-card-body">
                        <div id="logo-preview-wrap" class="preview-wrap {{ $profil->logo ? '' : 'hidden' }}">
                            <img id="logo-preview"
                                 src="{{ $profil->logo ? asset('storage/' . $profil->logo) : '#' }}"
                                 alt="Logo" class="preview-img logo-preview-img">
                        </div>
                        <div id="logo-placeholder" class="upload-placeholder {{ $profil->logo ? 'hidden' : '' }}">
                ...
                <div class="section-card">
                    ...
                    <div class="section-card-body">
                        <div id="gedung-preview-wrap" class="preview-wrap {{ $profil->foto_gedung ? '' : 'hidden' }}">
                            <img id="gedung-preview"
                                 src="{{ $profil->foto_gedung ? asset('storage/' . $profil->foto_gedung) : '#' }}"
                                 alt="Foto Gedung" class="preview-img gedung-preview-img">
                        </div>
                        <div id="gedung-placeholder" class="upload-placeholder {{ $profil->foto_gedung ? 'hidden' : '' }}">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <span>Pilih file untuk pratinjau</span>
                        </div>
                        <input type="file" name="foto_gedung" id="gedung-input"
                               class="file-input @error('foto_gedung') is-invalid @enderror"
                               accept="image/*"
                ...
                <div class="section-card">
                    <div class="section-card-body action-card-body">
                        ...
                        <a href="{{ route('admin.profil-yayasan.index') }}" class="btn-cancel">
