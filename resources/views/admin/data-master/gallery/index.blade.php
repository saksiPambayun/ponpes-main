...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="section-card">
            ...
            <div class="section-card-body">
                <form action="{{ route('admin.data-master.gallery.index') }}" method="GET" class="filter-form" id="filterForm">
                ...
                <div class="filter-group filter-actions">
                    ...
                    <div style="display:flex; gap:8px;">
                        ...
                        <a href="{{ route('admin.data-master.gallery.index') }}" id="resetBtn" class="btn-reset">
    ...
    <script>
        ...
        function submitFilter() {
            ...
            var url = '{{ route("admin.data-master.gallery.index") }}';
            var params = [];
                                ...
                                @forelse($galleries as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->gambar)
                                                <img src="{{ asset('storage/' . $item->gambar) }}" alt="{{ $item->judul }}"
                                                    class="foto-thumb" onclick="showImageModal('{{ asset('storage/' . $item->gambar) }}')"
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <span
                                                style="display: inline-flex; align-items: center; padding: 5px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 600; {{ $badgeStyle }}">
                                                {!! $badgeIcon !!} {{ $badgeText }}
                                            </span>
                                        </td>
                                        <td>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    if (cariButton) {
                        cariButton.addEventListener('click', function (e) {
                            ...
                            let url = '{{ route("admin.data-master.gallery.index") }}';
                            let params = [];
