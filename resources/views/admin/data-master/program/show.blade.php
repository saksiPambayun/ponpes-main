    ...
    <div class="page-wrapper" style="background: #f4f4f4; min-height: 100vh; padding: 2rem;">
        ...
        <div class="page-header"
            ...
            <div class="action-buttons" style="display: flex; gap: 0.5rem;">
                <a href="{{ route('admin.program.edit', $program->id) }}" class="btn-edit"
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="border-bottom: 1px solid #dfe8d8;">
                        ...
                        <td style="padding: 1rem 0; font-size: 0.87rem; color: #333;">
                            {{ $program->tanggal_mulai ? $program->tanggal_mulai->format('d F Y') : '-' }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #dfe8d8;">
                        <th
                            style="padding: 1rem 0; font-size: 0.82rem; font-weight: 600; color: #2d2d2d; text-align: left;">
                            Tanggal Selesai</th>
                        <td style="padding: 1rem 0; font-size: 0.87rem; color: #333;">
                            {{ $program->tanggal_selesai ? $program->tanggal_selesai->format('d F Y') : '-' }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #dfe8d8;">
                        <th
                            style="padding: 1rem 0; font-size: 0.82rem; font-weight: 600; color: #2d2d2d; text-align: left;">
                    ...
                    <tr style="border-bottom: 1px solid #dfe8d8;">
                        <th
                            ...
                            Dibuat Pada</th>
                        <td style="padding: 1rem 0; font-size: 0.87rem; color: #333;">
                            {{ $program->created_at->format('d F Y H:i') }}</td>
                    </tr>
                    <tr>
                        <th
                            style="padding: 1rem 0; font-size: 0.82rem; font-weight: 600; color: #2d2d2d; text-align: left;">
                            Terakhir Update</th>
                        <td style="padding: 1rem 0; font-size: 0.87rem; color: #333;">
                            {{ $program->updated_at->format('d F Y H:i') }}</td>
                    </tr>
                </table>
            </div>
        </div>
