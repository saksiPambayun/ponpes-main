        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <div class="flex gap-2 mt-3 md:mt-0">
                ...
                <a href="{{ route('admin.program.index') }}"
                    class="bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 font-medium py-2 px-4 rounded-lg transition inline-flex items-center">
                        ...
                        <table class="w-full">
                            ...
                            <tr class="border-b border-gray-100">
                                ...
                                <td class="py-3">
                                    ...
                                    @elseif($program->kategori == 'sosial')
                                        <span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs">❤️
                                            Sosial</span>
                            ...
                            <tr class="border-b border-gray-100">
                                ...
                                <td class="py-3">
                                    ...
                                    @else
                                        <span
                                            class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs">Ditunda</span>
                                    @endif
                                </td>
                            </tr>
                            <tr class="border-b border-gray-100">
                                ...
                                <td class="py-3 text-gray-800">:
                                    {{ $program->tanggal_mulai ? $program->tanggal_mulai->format('d F Y') : '-' }}
                                </td>
                            </tr>
                            <tr class="border-b border-gray-100">
                                <td class="py-3 text-gray-600 font-medium">Tanggal Selesai</td>
                                <td class="py-3 text-gray-800">:
                                    {{ $program->tanggal_selesai ? $program->tanggal_selesai->format('d F Y') : '-' }}
                                </td>
                            </tr>
                            <tr class="border-b border-gray-100">
