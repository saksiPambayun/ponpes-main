    ...
    <div class="col-md-6" style="flex: 1; min-width: 250px;">
        ...
        <div class="form-group" style="margin-bottom: 1rem;">
            ...
            <select name="divisi" class="form-select"
                ...
                <option value="pengurus" {{ old('divisi', $anggota->divisi ?? '') == 'pengurus' ? 'selected' : '' }}>
                    Pengurus</option>
                <option value="pengawas" {{ old('divisi', $anggota->divisi ?? '') == 'pengawas' ? 'selected' : '' }}>
                    Pengawas</option>
                <option value="pelaksana" {{ old('divisi', $anggota->divisi ?? '') == 'pelaksana' ? 'selected' : '' }}>
                    Pelaksana</option>
            </select>
        </div>
    </div>
    ...
    <div class="col-md-6" style="flex: 1; min-width: 250px;">
        ...
        <div class="form-group" style="margin-bottom: 1rem;">
            ...
            <input type="number" name="urutan" class="form-control"
                style="width: 100%; padding: 0.65rem 0.9rem; border: 1.5px solid #dfe8d8; border-radius: 10px; background: #f4f4f4; transition: all 0.2s ease;"
                value="{{ old('urutan', $anggota->urutan ?? 0) }}">
        </div>
    </div>
</div>
...
<div class="form-group" style="margin-bottom: 1rem;">
    ...
    <textarea name="deskripsi" rows="3" class="form-control"
        style="width: 100%; padding: 0.65rem 0.9rem; border: 1.5px solid #dfe8d8; border-radius: 10px; background: #f4f4f4; transition: all 0.2s ease;">{{ old('deskripsi', $anggota->deskripsi ?? '') }}</textarea>
</div>
