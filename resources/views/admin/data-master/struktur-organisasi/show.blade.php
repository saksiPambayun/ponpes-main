            ...
            <div class="col-lg-4" style="flex: 1; min-width: 280px;">
                <div
                    ...
                    <h3 style="font-size: 1.25rem; font-weight: 600; color: #222; margin: 0 0 0.25rem 0;">
                        {{ $anggota->nama }}</h3>
                    <p style="color: #2d2d2d; font-size: 0.85rem; margin-bottom: 1rem;">{{ $anggota->jabatan }}</p>
                    ...
                    <div style="display: flex; justify-content: center; gap: 0.5rem; margin-bottom: 1.5rem;">
                        <span style="display: inline-block; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.7rem; font-weight: 600;
                            @if($anggota->divisi == 'pengurus') background: #eef3ec; color: #005F02;
                            @elseif($anggota->divisi == 'pengawas') background: #dfe8d8; color: #0d4f14;
                            @else background: #8cbf73; color: #ffffff; @endif">
                            {{ ucfirst($anggota->divisi) }}
                        </span>
                        <span style="display: inline-block; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.7rem; font-weight: 600;
                            @if($anggota->status == 'aktif') background: #eef3ec; color: #005F02;
                        ...
                        <div style="text-align: left;">
                            @if($anggota->telepon)
                                <p
                                    ...
                                    <span style="color: #333;">{{ $anggota->telepon }}</span>
                                </p>
                            @endif
                            @if($anggota->email)
                                <p style="margin-bottom: 0; font-size: 0.85rem; display: flex; align-items: center; gap: 0.5rem;">
                                    ...
                                    <span style="color: #333;">{{ $anggota->email }}</span>
                                </p>
                            @endif
                        </div>
                    @endif
