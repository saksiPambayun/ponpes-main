...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            {{-- Filter & Search --}}
            <form method="GET" action="{{ route('admin.pegawai.index') }}" class="p-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($pegawai as $index => $p)
                            <tr class="hover:bg-indigo-50/30 transition group">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="text-sm font-mono text-gray-700 bg-gray-100 px-2 py-0.5 rounded">{{ $p->nip ?? '-' }}</span>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $tipeColor }}">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-1">
                                        ...
                                        {{-- Delete: wajib ada @csrf dan @method('DELETE') --}}
                                        <form action="{{ route('admin.pegawai.destroy', $p->id) }}" method="POST" class="inline"
                                            onsubmit="return confirm('Hapus data pegawai {{ addslashes($p->nama) }}?')">
                                            @csrf
                                            @method('DELETE')
