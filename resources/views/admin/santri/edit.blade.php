                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-1">
                        <label class="inline-flex items-center">
                            <input type="radio" name="jenis_kelamin" value="Laki-laki" {{ old('jenis_kelamin', $santri->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }} class="form-radio text-green-600">
                            <span class="ml-2">Laki-laki</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="jenis_kelamin" value="Perempuan" {{ old('jenis_kelamin', $santri->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }} class="form-radio text-green-600">
                ...
                <div>
                    ...
                    <select name="angkatan"
                        ...
                        @for($year = $startYear; $year <= $endYear; $year++)
                            <option value="{{ $year }}" {{ old('angkatan', $santri->angkatan ?? $currentYear) == $year ? 'selected' : '' }}>
                                {{ $year }}
                            </option>
                        @endfor
                    </select>
