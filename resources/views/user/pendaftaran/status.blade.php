...
@section('title', 'Detail Status Pendaftaran')
        ...
        <div class="container">
            <div class="status-card">
                ...
                <div class="status-content">
                    ...
                    @if($registration->announcement_date)
                        <div class="announcement-box">
                            ...
                            <p>{{ \Carbon\Carbon::parse($registration->announcement_date)->format('d/m/Y H:i') }}</p>
                        </div>
                    @endif
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('user.pendaftaran.download-pdf', $registration->id) }}" class="btn-download">
